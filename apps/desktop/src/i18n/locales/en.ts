export default {
  ...
  settings: {
    ...
    updateDownloadSourceDescription: "Choose where in-app update installers are downloaded from. GitHub is the default source; CNB can be faster on mainland China networks.",
    updateDownloadSourceGithub: "GitHub (default)",
